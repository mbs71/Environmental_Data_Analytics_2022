...
UV is the name of the service, after the service are the parameters and each paramter is seperated by &. 
...
#rdb is short for relational database which gives us a tab deliminiated format
...
APIs often require a key which is something you request and they provide to you. Google census key. 
...
SVI data = social vulnerability data
...
pull webpage into your coding environmnet
identify tags and pull them in using nodes
convert using test??
...
#2&3 Locate elements (find tags use selector gadget) and read their text attributes into variables
...
#if the year is 2020 it will be the first base url but if its anything else (aka any year other than 2020) it will be the second URL
