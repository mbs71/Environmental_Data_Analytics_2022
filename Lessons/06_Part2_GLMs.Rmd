...
aka is the mean of the litter biomass different at different sites
```{r}
# Wrangle the data
...
#results: reject null for all values where the pvalue is less than .05
#results: reject null in all except two: NIWO_057 and NIWO_046
qqnorm(Litter.Totals$dryMass); qqline(Litter.Totals$dryMass)

#qqnorm shows that the data does not follow a normal distribution 
